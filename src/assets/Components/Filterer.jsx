   ...
   <form action="./" method="get" autoComplete="off" noValidate="">
                  ...
                  <div className="mb-3">
                    <label className="form-check">
                      <input type="radio" className="form-check-input" name="form-stars" value="5 stars" checked="" />
                      <span className="form-check-label">5 stars</span>
                    </label>
                    <label className="form-check">
                      <input type="radio" className="form-check-input" name="form-stars" value="4 stars" />
                      <span className="form-check-label">4 stars</span>
                    </label>
                    <label className="form-check">
                      <input type="radio" className="form-check-input" name="form-stars" value="3 stars" />
                      <span className="form-check-label">3 stars</span>
                    </label>
                    <label className="form-check">
                      <input type="radio" className="form-check-input" name="form-stars" value="2 and less stars" />
                  ...
                  <div className="row g-2 align-items-center mb-3">
                    <div className="col">
                      <div className="input-group">
                        ...
                        <input type="text" className="form-control" placeholder="from" value="3" autoComplete="off" />
                      </div>
                    </div>
